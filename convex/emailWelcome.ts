...
// Email clients strip <script>/event handlers, but unescaped HTML still allows
// content/link injection — so escape defensively at the render boundary.
  ...
  <tr><td align="center" style="padding:48px 20px 32px 20px;">
    <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="background-color:#1A1830;border-radius:16px;padding:40px 40px 32px 40px;">
        ...
        <p style="margin:0 0 8px 0;font-size:22px;font-weight:700;color:#FFFFFF;line-height:1.3;font-family:'Courier New',Courier,monospace;">${safeName}, your quest awaits.</p>
...
function buildFullWelcomeHtml(data: FullWelcomeData): string {
  ...
  return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Ibhaveda — ${safeProjectName}</title></head>
<body style="margin:0;padding:0;background-color:#000000;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000000">
  <tr><td align="center" style="padding:48px 20px 32px 20px;">
    <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="background-color:#1A1830;border-radius:16px;padding:40px 40px 32px 40px;">
        ...
        <p style="margin:0 0 6px 0;font-size:22px;font-weight:700;color:#FFFFFF;line-height:1.3;font-family:'Courier New',Courier,monospace;">${safeUserName}. <span style="color:#FFDF00;">${safeProjectName}</span> is in the field.</p>
